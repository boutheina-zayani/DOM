...
var plus=Array.from(document.getElementsByClassName("fa fa-plus"))
var minus=Array.from(document.getElementsByClassName("fa fa-minus"))
var deleteBtns=Array.from(document.getElementsByClassName("fa fa-trash"))
